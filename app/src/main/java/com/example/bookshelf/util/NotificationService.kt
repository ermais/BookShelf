...
class NotificationService {
    ...
    companion object {
        ...
        fun builder(context: Context,max:Int,value:Int,title : String) : NotificationCompat.Builder{
        ...
        fun createNotificationChannel(context : Context){
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
                ...
                val descriptionChannel = context.
                getString(R.string.download_book_channel_description)
